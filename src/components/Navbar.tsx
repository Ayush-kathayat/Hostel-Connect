      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-2">
            <span className="text-hostel-blue font-bold text-2xl">
              Hostel<span className="text-hostel-orange">Connect</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link
              to="/about"
              className="text-gray-700 hover:text-hostel-blue transition"
            >
              About
            </Link>
            <Link
